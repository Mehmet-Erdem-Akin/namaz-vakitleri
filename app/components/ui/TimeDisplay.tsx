                        ...
                        >
                            ...
                            >
                                <div
                                    ...
                                    style={{
                                        background: 'linear-gradient(90deg, transparent 30%, rgba(30, 41, 59, 0.4) 50%, rgba(30, 41, 59, 0.85) 70%, rgba(15, 23, 42, 0.95) 85%)',
                                        borderRadius: '50%'
                                    }}
                                ></div>
                            </div>
                    ...
                    <div className="absolute" style={{
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                borderRadius: '50px',
                                boxShadow: '0 0 15px rgba(255, 255, 255, 0.4), inset 0 -10px 20px rgba(0, 0, 0, 0.1), 0 5px 15px rgba(0, 0, 0, 0.1)',
                                opacity: 0.9
                            }} />
                    ...
                    <div className="absolute" style={{
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                backgroundColor: 'white',
                                borderRadius: '50px',
                                boxShadow: '0 0 15px rgba(255, 255, 255, 0.4), inset 0 -10px 20px rgba(0, 0, 0, 0.1), 0 8px 20px rgba(0, 0, 0, 0.1)',
                                opacity: 0.9
                            }} />
                    ...
                    <div className="absolute" style={{
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                backgroundColor: 'white',
                                borderRadius: '50px',
                                boxShadow: '0 0 15px rgba(255, 255, 255, 0.4), inset 0 -10px 20px rgba(0, 0, 0, 0.1), 0 10px 20px rgba(0, 0, 0, 0.08)',
                                opacity: 0.9
                            }} />
                    ...
                    <div className="absolute" style={{
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                backgroundColor: 'white',
                                borderRadius: '30px',
                                boxShadow: '0 0 10px rgba(255, 255, 255, 0.3), inset 0 -5px 10px rgba(0, 0, 0, 0.1), 0 5px 10px rgba(0, 0, 0, 0.05)',
                                opacity: 0.85
                            }} />
