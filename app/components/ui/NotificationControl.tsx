...
import { checkNotificationPermission, requestNotificationPermission, registerServiceWorker, schedulePrayerNotification, sendPrayerNotification } from "../../services/notificationService";
                    ...
                    <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                        ...
                        <label className="relative inline-flex items-center cursor-pointer">
                            <input
                                ...
                                onChange={() => notificationsEnabled ? handleDisableNotifications() : handleEnableNotifications()}
                            />
